  ...
  <template v-if="!store.loadingObjects">
    <div :class="`list-container ${route.params.objtype}`">
      <div v-for="(obj, index) in store.objectList"  :key="index" class="row">
        ...
        <div class="col">
          <router-link :to="{ name: 'update', params: { objtype: route.params.objtype, id: obj.data.id }}"  class="btn btn-outline-secondary">
    ...
    <router-link :to="{ name: 'add', params: { objtype: route.params.objtype }}"  class="btn btn-outline-primary">
